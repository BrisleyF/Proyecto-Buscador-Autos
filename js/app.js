...
function mostrarAutos(autos) {
    ...
    limpiarHTML(); // elimina el HTML prpuertas
...
function llenarSelect() {
    ...
    for ( let i = max; i >= min; i--) {
        ...
        year.appendChild(opcion); // agraga las opciones del año al select
    }
}
...
function filtarAuto() {
    ...
    filtarPuertas ).filter( filtrarTransmision ).filter( filtrarColor );
